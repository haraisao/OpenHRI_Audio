...
if(UNIX)
    ...
    add_executable(${RTC_NAME} ${EXEC_SRCS} )
    add_dependencies(${RTC_NAME} ${RTC_NAME})
    add_dependencies(${RTC_NAME} ${RTC_NAME}-static)
    target_link_libraries(${RTC_NAME} ${RTC_NAME}-static ${LIBRARIES})

    add_executable(${RTC_NAME}-dynamic ${EXEC_SRCS})
    add_dependencies(${RTC_NAME}-dynamic ${RTC_NAME})
    target_link_libraries(${RTC_NAME}-dynamic ${RTC_NAME} ${LIBRARIES})
    set_target_properties(${RTC_NAME}-dynamic PROPERTIES LINK_FLAGS "${LDFLAGS}")
